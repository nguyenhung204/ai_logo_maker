    ...
    <Card className="group overflow-hidden transition-all duration-300 hover:shadow-lg">
      <div className="relative aspect-square overflow-hidden">
        <Image
          ...
          width={300}
          height={300}
          className="h-full w-full transition-transform duration-500 group-hover:scale-105 object-contain"
        />
      ...
      <CardContent>
        <p className="text-center text-sm text-muted-foreground">
          {bio ||
            "Passionate about creating innovative solutions through design and technology."}
        </p>
      </CardContent>
